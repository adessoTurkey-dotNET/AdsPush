...
namespace AdsPush.Vapid.Util
{
    ...
    internal static class Encryptor
    {
        ...
        private static EncryptionResult Encrypt(
            byte[] userKey,
            byte[] userSecret,
            byte[] payload)
        {
        ...
        private static byte[] AddPaddingToInput(
            byte[] data)
        {
        ...
        private static byte[] HKDFSecondStep(
            byte[] key,
            byte[] info,
            int length)
        {
        ...
        public static byte[] CreateInfoChunk(
            string type,
