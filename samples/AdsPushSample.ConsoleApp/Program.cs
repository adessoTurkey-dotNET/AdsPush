...
var basicPayload = new AdsPushBasicSendPayload()
{
    ...
    Badge = 52,
    Sound = "default",
    Parameters = new Dictionary<string, object>() { { "pushParam1", "value1" }, { "pushParam2", "value2" }, }
};
...
string
    endpoint =
        "https://fcm.googleapis.com/fcm/send/cIo6QJ4MMtQ:APA91bEGHCpZdHaUS7otb5_xU1zNWe6TAqria9phFm7M_9ZIiEyr0vXj3gRHbeIJMYvp2-SAVbgNrVvl7uBvU_VTLpIA0CLBcmqXuuEktGr0U4LVLvwWBibO68spJk7D-lr8R9zPyAXE",
    ...
    .SendAsync(
        new APNSRequest()
        {
            ApnsPayload = new()
            {
                ...
                ThreadId = "",
                TargetContentId = "",
                Alert = new APNSAlert() { Title = "", Body = "", Subtitle = "" }
                //more...
            },
            AdditionalParameters = new Dictionary<string, object>()
            {
                { "pushParam1", "value1" }, { "pushParam2", "value2" }, { "pushParam3", 52 },
            }
        },
...
var firebaseResult = await sender
    ...
    .SendToSingleAsync(new Message()
    {
        ...
        Notification = new() { Title = "", Body = "", ImageUrl = "" }
    });
...
var vapidResult = await sender
    ...
    .SendAsync(
        ...
        new VapidRequest()
        {
            ...
            ClickAction = "",
            VibratePattern = "",
            Data = new Dictionary<string, string>() { { "param1", "value1" } }
        });
